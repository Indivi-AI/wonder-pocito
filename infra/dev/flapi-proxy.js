// FLAPI proxy: forwards the app's package and metadata calls to an external FLAPI with the configured credentials.
...
if (process.argv[1] && import.meta.url === pathToFileURL(process.argv[1]).href)
  (await createFlapiApp()).listen(Number(process.env.PORT || 6001), '0.0.0.0')
