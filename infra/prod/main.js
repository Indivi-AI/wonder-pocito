// Pocito production server: the published-applet and lambda runtime, wfetch, the LLM proxy and the same-origin gateway; no live repo, no MCP.
import express from 'express'
import { pathToFileURL } from 'node:url'
import { setupPocitoGateway } from '../gateway.js'
import { setupWfetch } from '@wonder/server/wfetch.js'
import { setupRoomLambdaAndApplet } from '@wonder/server/room-lambda-and-applet.js'
import { setupLlmProxyRoute } from '@wonder/server/llm-proxy-onprem.js'
