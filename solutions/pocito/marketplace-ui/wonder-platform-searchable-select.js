...
ReactComp('wonderPlatformSearchableSelect', {
  impl: comp({
    hFunc: (ctx, {react: {h, useState}}) => ({items, value, onChange, placeholder, empty, testId, multi, bare}) => {
      ...
      return h('div:relative', {}, h(`button:flex w-full items-center justify-between gap-2 px-3 py-2.5 text-sm${
