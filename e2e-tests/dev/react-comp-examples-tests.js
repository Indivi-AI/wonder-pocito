...
import '../../ui/examples/room-state-react-comp.js'
import '../../ui/examples/stable-chat-react-comp.js'
import '../../ui/examples/llm-flow-react-comp.js'
import '../../ui/examples/wfetch2-guide-react-comp.js'
import '../../ui/examples/json-file-import-guide-react-comp.js'
import '../../ui/examples/enrich-ctx-guide-react-comp.js'
...
Test('reactCompExamples.registry', {
  impl: dataTest({
    ...
    expectedResult: equals('%result%', asIs({
      store: true, roomState: true, stableChat: true, composer: true, llmFlow: true, answer: true,
      wfetch2: true, fileImport: true, enrichCtx: true
    }))
  })
})
